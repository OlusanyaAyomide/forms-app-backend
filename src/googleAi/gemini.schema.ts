  ...
  items: {
    ...
    properties: {
      ...
      correct_answer: {
        type: SchemaType.ARRAY,
        description:
          'An Array of marked answers,it should multiple strings if there are more than one answer,should be capitalized, or null, if no answer is present',
        items: {
          type: SchemaType.STRING,
      ...
      question_type: {
        ...
        enum: ['Text', 'Select'],
        description:
          "The type of question: 'TextArea' if no options, 'Select' if options are present",
      },
      explanation: {
        type: SchemaType.STRING,
        description:
          'The explanation to the correct answer for correction purpose',
        nullable: true,
      },
    },
